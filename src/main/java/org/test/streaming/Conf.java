...
public class Conf {
	...
	//	public static final String VIDEO = "Alcatraz.S01E11.Webb.Porter.HDTV.x264-LOL.mp4";
	...
	public static final String VIDEO = "Game.of.Thrones.S02E01.HDTV.RM-ASAP.mp4";
	...
	//	public static final String NOTIFIER_URL_BASE = "http://indice.herokuapp.com/";
	...
	//	public static final String PREVALENCE_DIR = "/home/matias/servle.prevalence";
	public static final String SUBS = "Luther-02x01-SP.srt";



	public static final String VIDEO_ID_FOR_TESTING = "d1a27cdb480dbd3f9d1adbca766cb44e98fd6db8"; //TODO sacar del param del request
